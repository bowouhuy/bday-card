...
<head>
    ...
    <link rel="stylesheet" href="style2.scss" type="text/css"> 
</head>
<body class="" id="hammer" style="background: rgb(190, 166, 166);">
<!-- <div class="container mt-5 col-12 ">
    <div class="col text-center">
        <img src="robot-selfie-crop.gif" class="rounded robot mx-auto d-block animate__animated animate__zoomIn" id="robot" style="width:23em;" hidden>
        <h1 class="animate__animated animate__zoomIn animate__delay-2s">hi</h1>
...
function play() {
  ...
  const start = () => {
        setTimeout(function() {
            confetti.start()
        }, 7000); // 1000 is time that after 1 second start the confetti ( 1000 = 1 sec)
    };
